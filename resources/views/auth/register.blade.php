                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('nombre_negocio') ? ' has-error' : '' }}">
                            <label for="nombre_negocio" class="col-md-4 control-label">Nombre del negocio</label>

                            <div class="col-md-6">
                                <input id="nombre_negocio" type="text" class="form-control" name="nombre_negocio" value="{{ old('nombre_negocio') }}" required autofocus>
