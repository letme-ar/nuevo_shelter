...
@section('content')
    ...
    <div class="col-md-6">
        {!! Field::text('nombre',null,['v-model' => 'grupo.nombre']) !!}
    </div>
    <div class="col-md-6">
        <div class="form-group">
            <label for="estilo_id" class="control-label">Estilo</label>

            <select class="form-control" name="estilo_id" v-model="grupo.estilo_id">
                <option></option>
    ...
    <div class="col-md-6">
        {!! Field::text('web',null,['v-model' => 'grupo.web']) !!}
    </div>
    <div class="col-md-6">
        <div class="panel panel-primary" style="min-height: 300px">
            ...
            <div class="panel-body">
                ...
                <div class="form-inline">
                    {!! Form::text('nombre_contacto',null,['class' => 'form-control','placeholder' => 'Nombre','v-model' => 'nombre_contacto','@keyup'=>"allowAdd()"]) !!}
