...
<!--            {!! Form::checkbox('chk_facebook',null) !!}-->
        ...
        <div class="col-md-6 form-inline" style="margin-top: 10px">
<!--            {!! Form::checkbox('chk_twitter',null) !!}-->
            <div class="input-group">
                    <span class="input-group-addon">
        ...
        <div class="col-md-6 form-inline" style="margin-top: 10px">
<!--            {!! Form::checkbox('chk_instagram',null) !!}-->
            <div class="input-group">
                    <span class="input-group-addon">
        ...
        <div class="col-md-6 form-inline" style="margin-top: 10px">
<!--            {!! Form::checkbox('chk_youtube',null) !!}-->
            <div class="input-group">
                    <span class="input-group-addon">
...
<!--            {!! Form::checkbox('chk_vimeo',null) !!}-->
        ...
        <div class="col-md-6 form-inline" style="margin-top: 10px">
<!--            {!! Form::checkbox('chk_bandcamp',null) !!}-->
            <div class="input-group">
                    <span class="input-group-addon">
        ...
        <div class="col-md-6 form-inline" style="margin-top: 10px">
<!--            {!! Form::checkbox('chk_spotify',null) !!}-->
            <div class="input-group">
                    <span class="input-group-addon">
