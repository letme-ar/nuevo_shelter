    ...
    <script>
        vm = new Vue({
            ...
            methods:{
                ...
                buscar: function(url){
                    ...
                    if(url == undefined)
                        var url = "{{route('servicios.buscar')}}" + "?" + "page=1&descripcion="+this.servicio.descripcion;
                    var descripcion = this.descripcion;
                    descripcion._token = this.token;
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            vm.lista = data.data;
                            vm.first = "{{route('servicios.buscar')}}" + "?page=1";
                            ...
                            vm.last = "{{route('servicios.buscar')}}" + "?page="+data.last_page;
                            HoldOn.close();
                            vm.busqueda = false;
                        },
        ...
        $(document).ready(function(){
            $("#eliminar-1").click(function(){
                ...
                var urlDelete = "{{route('servicios.eliminar')}}";
                ...
                $.ajax({
                    ...
                    success: function(respuesta)
                    {
                        ...
                        $("#contenido-modal-1").html("Se ha eliminado el servicio");
...
@section('content')
    ...
    <h1>Servicios
        <a href="{!! route('servicios.create')!!}"><button class="btn btn-success pull-right" >Agregar</button></a>
    </h1>
    ...
    <div v-show="lista.length > 0">
        ...
        <table class="table responsive table-bordered table-hover table-striped" style="margin-top: 10px" >
            ...
            <tr v-for="registro in lista" class="@{{ registro.principal ? 'principal' : '' }}">
                ...
                <td>
                    <a data-toggle="tooltip" data-placement="top"  title='Editar' href="{{route('servicios.index')}}/@{{ registro.id }}/edit"><i class='glyphicon glyphicon-edit' ></i></a>
